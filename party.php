...
function setText(person,picture,set)
{
	...
	case "will":
		...
		break;
	case "dan":
		text = "<div style='font-size: 180%;'>Daniel Spencer</div><img src='images/party/groomsman.jpg' style='padding: 5px 0px;' /><br>Dan was the first person Spencer thought of outside of family for a groomsman.  Not only were they friends at GBHS, but they both went to Virginia Tech where they spent many hours (along with Jennifer and Nicole) playing pool at The BreakZone.  Dan is currently working at Wachovia as a Loan Service Counselor.";
		break;
	case "keri":
		text = "<div style='font-size: 180%;'>Keri McClure</div><img src='images/party/maidofhonor.jpg' style='padding: 5px 0px;' /><br>When deciding on her maid of honor it was clear to Jennifer that no one else could fill those shoes but her sister. Keri is not only family but Jennifer's best friend. Her humor, smile, and unique look at life make her a constant rock that Jennifer can go to for advice, a listening ear, or a fun girls' night out. Keri will be returning to Christopher Newport University in the fall as a sophmore majoring in Business Management.";
		break;
	case "sean":
